...
class OMNITRAX_PT_PoseEstimationPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col.label(
            text="DLC network path: [path to the directory of your trained network]"
        )
        ...
        col.operator(
            "scene.pose_estimation_run", text="ESTIMATE POSES"
        ).fullframe = False
        col.operator(
            "scene.pose_estimation_run", text="ESTIMATE POSES [full frame]"
        ).fullframe = True
