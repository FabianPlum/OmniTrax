...
detection-based buffer-and-recover tracking with
...
For the provided [trained networks](trained_networks.md) we aim to minimise manual labelling effort by training these 
networks on [synthetically generated data](https://github.com/FabianPlum/FARTS)
...
_Keep in mind that given the focus on multi-animal applications, apart from ease of 
...
relevant individuals. Refer to our [tracking tutorial](tutorial-tracking.md) for an in-depth guide of how to set up
