...
Installing [**CUDA** (Compute Unified Device Architecture)](https://en.wikipedia.org/wiki/CUDA) is widely regarded as one of the least fun but sadly essential endeavours when diving into machine
...
<img src=CUDA_installation_images/CUDA_01.PNG width="700">

Once you ensured you have picked the correct version for your system, download the **Base Installer**

<img src=CUDA_installation_images/CUDA_02.PNG width="700">
...
<img src=CUDA_installation_images/CUDA_04.PNG width="700">

Once you have created an account, sign in and continue the download.

<img src=CUDA_installation_images/CUDA_05.PNG width="700">
...
<img src=CUDA_installation_images/CUDA_06.PNG width="700">
...
<img src=CUDA_installation_images/CUDA_07.PNG width="700">

Unless you really know what you are doing, choosing the express installation option should be sufficient.

<img src=CUDA_installation_images/CUDA_08.PNG width="700">
...
<img src=CUDA_installation_images/CUDA_09.PNG width="700">

Wait for the installation to complete.

<img src=CUDA_installation_images/CUDA_10.PNG width="700">
...
<img src=CUDA_installation_images/CUDA_12.PNG width="700">
